...
export default class extends Controller {
    ...
    connect() {
        console.log("Stimulus type_order conectado!");
    ...
    setActive(type) {
        if (type === "ride") {
            this.descriptionInputTarget.classList.add("hidden", "opacity-50")
            ...
            this.descriptionInputTarget.classList.remove("hidden", "opacity-50")
